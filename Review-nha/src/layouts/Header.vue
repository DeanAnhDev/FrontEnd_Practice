<template>
  <header>
    ...
    >
      <div class="flex items-center space-x-4">
        <button @click="toggleMenu">
          <MenuIcon class="xl:hidden cursor-pointer" />
        </button>
      ...
      <div class="flex items-center space-x-4">
        <NotificationIcon class="xl:hidden cursor-pointer" />
    ...
    <transition name="fade-slide">
      <div v-if="isMobileMenuOpen" class="fixed inset-0 bg-white z-50 xl:hidden">
        <!-- Nút đóng -->
        <div class="mt-5 p-3 flex align-center items-center space-x-2">
          <button @click="toggleMenu" class="text-gray-800 text-4xl font-bold">
            <svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
        ...
        <ul class="flex flex-col space-y-10 md:space-y-15 text-2xl font-bold text-gray-500 p-3 mt-10 md:text-5xl">
          ...
          <li
            @click="toggleMenu"
            class="group relative cursor-pointer text-red-500 hover:text-red-500 after:content-[''] after:absolute after:top-1/2 after:right-3  md:after:w-[50%] after:ml-2 after:w-25 after:h-[5px] after:bg-gray-800 after:translate-y-[-50%] group-hover:after:bg-red-500 after:bg-red-500"
          >
            Khám phá
          </li>
        ...
        <div class="flex flex-col items-center mt-40 space-y-4 md:mt-80">
          <!-- Nút Đăng bài -->
          <button
            class="md:text-lg md:w-[80%] md:p-4 w-80 px-6 py-2 rounded-full font-semibold text-white bg-[#D93C23] border-2 border-[#D93C23] hover:bg-white hover:text-[#D93C23] hover:shadow-lg transition-all duration-300 cursor-pointer"
          >
            Đăng bài
          </button>
          ...
          <div class="flex gap-4 w-[80%] md:text-lg">
            <!-- Đăng nhập -->
            <button
              class=" md:w-[100%] md:p-4  w-38 px-4 py-2 rounded-full font-semibold text-[#3B4144] bg-white border-2 border-[#3B4144] hover:bg-[#3B4144] hover:text-white hover:shadow-lg transition-all duration-300 cursor-pointer"
            >
              Đăng nhập
            </button>
            ...
            <!-- Đăng ký -->
            <button
              class="md:p-4 md:w-[100%] w-38 px-4 py-2 rounded-full font-semibold text-white bg-[#3B4144] border-2 border-[#3B4144] hover:bg-white hover:text-[#3B4144] hover:shadow-lg transition-all duration-300 cursor-pointer"
            >
              Đăng ký
            </button>
          </div>
